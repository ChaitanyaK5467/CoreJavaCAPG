...
public class AccountMain {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("9. Add Account in Map");	// Adding Map<Integer,List<Account>> where Integer is already generated in addAccountDetails();
			System.out.println("10. Group Account Based on Location");
	...
	public void addDetailsInMap() {
		...
		if (a != null) {
			Map<Integer, List<Account>> notification = server.addAccDetailsMap(a);
	        System.out.println("Notification : " + notification);
	    } else {
	...
	public void groupAccountsByLocation() {
	    Map<String, List<Account>> accountGroups = server.groupAccountsByLocation();

	    for (Map.Entry<String, List<Account>> entry : accountGroups.entrySet()) {
